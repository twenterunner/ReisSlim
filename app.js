import { BUILD, ENGINE_VERSION, STORAGE_SCHEMA_VERSION, VERSION, preferenceDefinitions } from './config.js?v=1905';
import { destinations } from './destinations.js?v=1905';
import { buildProposalPortfolio, getMoreProposals } from './proposal-engine.js?v=1905';
import { discoverDestinationBatch } from './destination-provider.js?v=1905';
import { buildItinerary } from './itinerary-engine.js?v=1905';
import { buildItineraryVariants } from './itinerary-variants.js?v=1905';
import { buildBudget } from './budget-engine.js?v=1905';
import { calculateTripQuality } from './trip-quality-engine.js?v=1905';
import { applyOptimizationProposal, optimisePlan, proposeOptimizations } from './trip-optimizer.js?v=1905';
import { validatePlan } from './itinerary-validator.js?v=1905';
import { clearDraft, deleteTrip, loadDraft, loadTrips, saveDraft, saveTrip } from './storage.js?v=1905';
import { localDate, normalizeTrip, readTripForm, validateTripInput, writeTripForm } from './trip-model.js?v=1905';
import { downloadGpx, downloadJson } from './gpx-generator.js?v=1905';
import { invalidateMap, renderMap } from './map-view.js?v=1905';
import { enrichPlanWithLiveRouting, readRoutingSettings, routingConfigured, saveRoutingSettings } from './routing-provider.js?v=1905';
import { evaluatePlanConstraints } from './constraint-engine.js?v=1905';
import { enrichPlanWithPlaces, fetchWeatherForDestination, geocodeOrigin, prepareGeneratedRouteStops } from './place-provider.js?v=1905';
import { $, renderComparison, renderDashboard, renderDestinations, renderItineraryVariants, renderOptimizationPreview, renderPlan, renderPreferenceGrid, renderVehicleControls, setStatus, showError, showView } from './ui-renderer.js?v=1905';
import { loadPreferenceProfile, recordPreferenceEvent, savePreferenceProfile } from './preference-engine.js?v=1905';
import { applyAssistantPatch, interpretAssistantMessage } from './assistant-engine.js?v=1905';
import { enrichDestinationImages } from './image-provider.js?v=1905';
import { weatherWindowScore } from './weather-engine.js?v=1905';
import { ROADTRIP_POLICY, estimatedRoadKm, maximumRoadLegKm, planningSpeedKmh, repeatStayAllowed, requiredDistinctOvernights, selectRoadtripOvernights, selectRoadtripBase, selectBaseDayTrips, validateRoadtrip } from './roadtrip-policy.js?v=1905';
import { enrichOvernightAccommodations } from './overnight-accommodation.js?v=1905';
import { discoverRegionalOvernightCandidates } from './regional-overnight-provider.js?v=1905';
...
window.reisslimSubmitTrip=submitTripForm;
