importScripts('./runtime-source-repair-1954.js');

const CACHE='reisslim-v1.16.4-build-1954-deployment-contract-v1';
const IMAGE_CACHE='reisslim-runtime-images-v5-grounded-delivery';
const RELEASE_VERSION='1.16.4';
const RELEASE_BUILD='1954';
const ASSETS=[
...
'./roadtrip-runtime-engine.js','./start-new-trip.js','./planner-submit-guard.js','./canonical-trip-engine.js','./canonical-place-resolver.js','./canonical-recommendation-coverage.js','./runtime-source-repair-1954.js','./release-sync-1954.js'
];
...
self.addEventListener('activate',event=>{
  event.waitUntil((async()=>{
    ...
    // Reload every open ReisSlim window exactly once so 1954 takes control of
    // app.js immediately instead of requiring a second manual refresh/restart.
    const clients=await self.clients.matchAll({type:'window',includeUncontrolled:true});
    await Promise.allSettled(clients.map(async client=>{
      try{
        const url=new URL(client.url);
        if(url.origin!==self.location.origin||url.searchParams.get('runtime')==='1954')return;
        url.searchParams.set('runtime','1954');
...
function syncSourceText(text,pathname=''){
  let out=String(text)
  .replace(/1\.13\.0-1923-data-engine/g,'1.16.4-1954-deployment-contract-v1')
  .replace(/1\.14\.1-1928-synchronized/g,'1.16.4-1954-deployment-contract-v1')
  .replace(/1\.14\.2-1929-(?:complete-stops|header-repair)/g,'1.16.4-1954-deployment-contract-v1')
  .replace(/1\.14\.3-1930-roadtrip-policy/g,'1.16.4-1954-deployment-contract-v1')
  .replace(/1\.14\.4-1931-roadtrip-resilience/g,'1.16.4-1954-deployment-contract-v1')
  .replace(/1\.14\.5-1932-topology-supply/g,'1.16.4-1954-deployment-contract-v1')
  .replace(/1\.14\.6-1933-(?:cape-global-images|global-images)/g,'1.16.4-1954-deployment-contract-v1')
  .replace(/1\.15\.0-1940-global-adaptive/g,'1.16.4-1954-deployment-contract-v1')
  .replace(/1\.15\.1-1941-selected-trip-contract/g,'1.16.4-1954-deployment-contract-v1')
  .replace(/1\.15\.2-1942-bounded-solver/g,'1.16.4-1954-deployment-contract-v1')
  .replace(/1\.15\.3-1943-runtime-contract/g,'1.16.4-1954-deployment-contract-v1')
  .replace(/1\.15\.4-1944-roadtrip-boundary/g,'1.16.4-1954-deployment-contract-v1')
  .replace(/1\.15\.5-1945-input-limit-contract/g,'1.16.4-1954-deployment-contract-v1')
  .replace(/1\.15\.6-1946-location-grounded-images/g,'1.16.4-1954-deployment-contract-v1')
  .replace(/1\.15\.7-1947-night-complete-accommodations/g,'1.16.4-1954-deployment-contract-v1')
  .replace(/1\.15\.8-1948-grounded-image-delivery/g,'1.16.4-1954-deployment-contract-v1')
  .replace(/1\.15\.9-1949-multileg-base-transit/g,'1.16.4-1954-deployment-contract-v1')
  .replace(/\?v=(?:1923|1928|1929|1930|1931|1932|1933|1940|1941|1942|1943|1944|1945|1946|1947|1948|1949|1950|1951|1952|1953)\b/g,'?v=1954')
  .replace(/version:'1\.13\.0',build:'1923'/g,"version:'1.16.4',build:'1954'")
  .replace(/version:'1\.14\.1',build:'1928'/g,"version:'1.16.4',build:'1954'")
  .replace(/version:'1\.14\.2',build:'1929'/g,"version:'1.16.4',build:'1954'")
  .replace(/version:'1\.14\.3',build:'1930'/g,"version:'1.16.4',build:'1954'")
  .replace(/version:'1\.14\.4',build:'1931'/g,"version:'1.16.4',build:'1954'")
  .replace(/version:'1\.14\.5',build:'1932'/g,"version:'1.16.4',build:'1954'")
  .replace(/version:'1\.15\.0',build:'1940'/g,"version:'1.16.4',build:'1954'")
  .replace(/version:'1\.15\.1',build:'1941'/g,"version:'1.16.4',build:'1954'")
  .replace(/version:'1\.15\.2',build:'1942'/g,"version:'1.16.4',build:'1954'")
  .replace(/version:'1\.15\.3',build:'1943'/g,"version:'1.16.4',build:'1954'")
  .replace(/version:'1\.15\.4',build:'1944'/g,"version:'1.16.4',build:'1954'")
  .replace(/version:'1\.15\.5',build:'1945'/g,"version:'1.16.4',build:'1954'")
  .replace(/version:'1\.15\.6',build:'1946'/g,"version:'1.16.4',build:'1954'")
  .replace(/version:'1\.15\.7',build:'1947'/g,"version:'1.16.4',build:'1954'")
  .replace(/version:'1\.15\.8',build:'1948'/g,"version:'1.16.4',build:'1954'")
  .replace(/version:'1\.15\.9',build:'1949'/g,"version:'1.16.4',build:'1954'")
  .replace(/version:'1\.16\.0',build:'1950'/g,"version:'1.16.4',build:'1954'")
  .replace(/version:'1\.16\.1',build:'1951'/g,"version:'1.16.4',build:'1954'")
  .replace(/version:'1\.16\.2',build:'1952'/g,"version:'1.16.4',build:'1954'")
  .replace(/version:'1\.16\.3',build:'1953'/g,"version:'1.16.4',build:'1954'")
  .replace(/\.\/routing-provider-1914\.js\?v=1954/g,'./routing-provider.js?v=1954');
  ...
  if(/(?:^|\/)app\.js$/i.test(pathname)){
    if(self.ReisSlimRuntimeRepair1954?.repairAppContract)out=self.ReisSlimRuntimeRepair1954.repairAppContract(out);
...
function injectReleaseScript(html){
  let text=syncSourceText(html)
    .replace(/<script[^>]*release-sync-(?:1928|1929|1930|1931|1932|1933|1940|1941|1942|1943|1944|1945|1946|1947|1948|1949|1950|1951|1952|1953|1954)\.js[^>]*><\/script>/gi,'');
  ...
  return text.replace(/<\/body>/i,'<script src="./release-sync-1954.js?v=1954"></script></body>')
}
...
self.addEventListener('message',event=>{
  if(event?.data?.type!=='REISSLIM_VERSION_REQUEST')return;
  const payload={version:RELEASE_VERSION,build:RELEASE_BUILD};
  try{if(event.ports?.[0])event.ports[0].postMessage(payload);else event.source?.postMessage?.(payload)}catch{}
});
