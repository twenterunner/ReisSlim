(function(){
  const VERSION='1.15.2',BUILD='1942';
  ...
  function bind(){const structure=document.getElementById('tripStructure');if(structure&&!structure.dataset.changeSemantics1942){structure.dataset.changeSemantics1942='1';structure.addEventListener('change',syncPlannerSemantics)}}
