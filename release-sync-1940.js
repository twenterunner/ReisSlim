(function(){
  const VERSION='1.15.0',BUILD='1940';
  ...
  function bind(){const structure=document.getElementById('tripStructure');if(structure&&!structure.dataset.changeSemantics1940){structure.dataset.changeSemantics1940='1';structure.addEventListener('change',syncPlannerSemantics)}}
