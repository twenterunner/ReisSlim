...
test('Service worker caches the decision-intelligence module',()=>{
 const sw=fs.readFileSync('./service-worker.js','utf8');assert.ok(sw.includes('./decision-intelligence.js'));assert.ok(sw.includes('./implementation-governance.js'));assert.ok(sw.includes("labos-v1.16.0"));
});
