(function(){
  const VERSION='1.15.3',BUILD='1943';
  ...
  function bind(){const structure=document.getElementById('tripStructure');if(structure&&!structure.dataset.changeSemantics1943){structure.dataset.changeSemantics1943='1';structure.addEventListener('change',syncPlannerSemantics)}}
