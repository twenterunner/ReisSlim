(function(){
  const VERSION='1.15.1',BUILD='1941';
  ...
  function bind(){const structure=document.getElementById('tripStructure');if(structure&&!structure.dataset.changeSemantics1941){structure.dataset.changeSemantics1941='1';structure.addEventListener('change',syncPlannerSemantics)}}
