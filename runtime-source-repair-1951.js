(function(root){
  ...
  function injectCanonicalImports(text){
    if(!/from ['"]\.\/canonical-trip-engine\.js/.test(text))text=`import { buildCanonicalTripPlan, canonicalPlanDiagnostic, isCanonicalPlan } from './canonical-trip-engine.js?v=1951';\nimport { resolveCanonicalPlanPlaces } from './canonical-place-resolver.js?v=1951';\n${text}`;
    return text
  }
  ...
  root.ReisSlimRuntimeRepair1951=Object.freeze({repairAppContract});
